...
const scenario: Template[] = [
  ...
  { phase: 'DECIDE', status: 'warning', title: 'Route classified as HIGH risk', summary: 'The route requires immediate operational attention.', route, metrics, decision: { riskLevel: 'HIGH', confidence: 94, action: 'Creating payment incident' }, durationMs: 1090 },
